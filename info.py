...
API_ID = int(environ.get('API_ID', '12850056')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '15564ec4a1a2cbef87c99a9aa9e40b34')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8038959085:AAFDil_BGGNN81KFpbD1HsJ3cV-t6BUscII")    # Bot token from @BotFather
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '770434685').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1004450008589').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001732233845'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1001732233845'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001732233845'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1001919929458').split()] #(make sure bot is admin)
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003967171091')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001732233845')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/anomovies')  # Support group link (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1003967171091")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filterbot:7872278427kd@cluster0.xvfhkk0.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/AnoMovies")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/AnoMovies")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/AnoMovies")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/AnoMovies') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/AnoMovies') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/AnoMovies') # Update channel link for the bot
...
DELETE_TIME = int(environ.get("DELETE_TIME", "108000"))  #  deletion time in seconds (default: 5 minutes). Adjust as per your needs.
